...
class Admin {
    ...
    public ArrayList<Mahasiswi> daftarMahasiswa = new ArrayList<>();

    public Admin(Scanner scanner) {
        this.scanner = scanner;

        Mahasiswi mahasiswa1 = new Mahasiswi(scanner);
        ...
        Mahasiswi mahasiswa2 = new Mahasiswi(scanner);
    ...
    private void tampilkanMahasiswa() {
        ...
        for (Mahasiswi mahasiswa : daftarMahasiswa) {
